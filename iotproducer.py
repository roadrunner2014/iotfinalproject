...
# connect to Kafka broker on CloudKarafka
topic = os.environ['CLOUDKARAFKA_TOPIC'].split(",")[0]

# confluent_kafka producer info for CloudKarafka
conf = {'bootstrap.servers': os.environ['CLOUDKARAFKA_BROKERS'],
	'session.timeout.ms': 6000,
        'default.topic.config': {'auto.offset.reset': 'smallest'},
        'security.protocol': 'SASL_SSL',
	'sasl.mechanisms': 'SCRAM-SHA-256',
	'ssl.ca.location': '/home/ubuntu/iotfinalproject/cloudkarafka.ca',
        'sasl.username': os.environ['CLOUDKARAFKA_USERNAME'],
        'sasl.password': os.environ['CLOUDKARAFKA_PASSWORD']
    }

iotproducer = Producer(**conf)
